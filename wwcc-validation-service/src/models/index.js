...
db.workingWithChildrenCheck = require('./workingWithChildrenCheck.js')(sequelize, Sequelize);
db.checkType = require('./checkType.js')(sequelize, Sequelize);

// Define associations
db.workingWithChildrenCheck.associate({ CheckType: db.checkType });
